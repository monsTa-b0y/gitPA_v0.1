  ...
  try {
    ...
    const completion = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: 'system',
          content: 'You are a helpful assistant that analyzes GitHub repositories. Always format your responses using markdown. Use code blocks with language specification for code examples, and use proper markdown formatting for lists, headings, and other elements.',
        },
        {
          role: 'user',
